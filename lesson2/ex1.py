...
name: str = "Nozomi"
age: int = 27
self_introduction: str = "My name is {0:s}. I'm {1:d} years old.".format(name, age)
...
# INSERT YOUR CODE HERE
osp_versions: dict[str, str] = {"13":"Queens", "16":"Train", "17":"Wallaby"}

for version, codename in osp_versions.items():
    print("")
    print("RHOSP {0:s} is based on {1:<20s}!".format(version, codename))
    print("RHOSP {0:s} is based on {1:^20s}!".format(version, codename))
    print("RHOSP {0:s} is based on {1:>20s}!".format(version, codename))
